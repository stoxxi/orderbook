...
📦 [npm](https://www.npmjs.com/package/@stoxxi/orderbook) · 🔗 [source](https://github.com/stoxxi/orderbook) · 🐛 [issues](https://github.com/stoxxi/orderbook/issues)
...
- `BboListener` — `onBboChange`. ⚠️ The `Bbo` object is a reused double-buffer: read it synchronously or copy its primitives; never retain the reference.
